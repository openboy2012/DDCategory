...
//! Project version number for DDCategory.
FOUNDATION_EXPORT double DDCategoryVersionNumber;

//! Project version string for DDCategory.
FOUNDATION_EXPORT const unsigned char DDCategoryVersionString[];
